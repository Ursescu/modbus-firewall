...
eMBErrorCode eMBRegInputCBSerialSlave(UCHAR* pucRegBuffer, USHORT usAddress,
    ...
    if ((usAddress >= usInputRegStart) && (pucInputBuffer != NULL) && (usNRegs >= 1) && ((usAddress + usRegs) <= (usInputRegStart + usRegInputNregs + 1)) && (usRegInputNregs >= 1)) {
...
eMBErrorCode eMBRegHoldingCBSerialSlave(UCHAR* pucRegBuffer, USHORT usAddress,
    ...
    if ((usAddress >= usRegHoldingStart) && (pucHoldingBuffer != NULL) && ((usAddress + usRegs) <= (usRegHoldingStart + usRegHoldingNregs + 1)) && (usRegHoldingNregs >= 1) && (usNRegs >= 1)) {
...
eMBErrorCode eMBRegCoilsCBSerialSlave(UCHAR* pucRegBuffer, USHORT usAddress,
    ...
    if ((usAddress >= usRegCoilsStart) && (usRegCoilNregs >= 1) && ((usAddress + usCoils) <= (usRegCoilsStart + (usRegCoilNregs << 4) + 1)) && (pucRegCoilsBuf != NULL) && (usNCoils >= 1)) {
...
eMBErrorCode eMBRegDiscreteCBSerialSlave(UCHAR* pucRegBuffer, USHORT usAddress,
    ...
    usAddress--;
    if ((usAddress >= usRegDiscreteStart) && (usRegDiscreteNregs >= 1) && (pucRegDiscreteBuf != NULL) && ((usAddress + usNDiscrete) <= (usRegDiscreteStart + (usRegDiscreteNregs * 16))) && (usNDiscrete >= 1)) {
